module.exports = {
	...
	token: process.env.token || "NzI5ODYxNDQ4NTI3NzczNzU4.GphlLM.5YtGb5M1pgRolWlAskXu4iwSx15YfbXEHRaQ2s", //- Bot's Token
	clientId: process.env.clientId || "729861448527773758", //- ID of the bot
	clientSecret: process.env.clientSecret || "gJmWe1XtBzn_UifrbQrFeYgcjSUPxD5w", //- Client Secret of the bot
	port: 4200, //- Port of the API and Dashboard
	scopes: ["identify", "guilds", "applications.commands"], //- Discord OAuth2 Scopes
	inviteScopes: ["bot", "applications.commands"], // Invite link scopes
	serverDeafen: true, //- If you want bot to stay deafened
	defaultVolume: 4, //- Sets the default volume of the bot, You can change this number anywhere from 1 to 100
	...
	cookieSecret: "tylerismyname", //- Cookie Secret
	website: "https://lavalink.lexnet.cc:443", //- without the / at the end
